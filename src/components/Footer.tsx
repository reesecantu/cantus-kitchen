        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:pl-0 pl-6">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="inline-block mb-4 -ml-3 md:-mt-6">
              <img
                ...
                className="h-15 filter brightness-0 invert"
              />
            </Link>
            <p className="text-gray-300 text-sm max-w-md">
              My silly website for making grocery lists
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {/* Instagram */}
              <a
                href="https://instagram.com/cantus.kitchen"
                target="_blank"
              ...
              {/* GitHub */}
              <a
                href="https://github.com/reesecantu/cantus-kitchen"
                target="_blank"
                rel="noopener noreferrer"
