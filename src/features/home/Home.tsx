...
export const Home = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div
        className={`py-15 px-6 sm:px-10 lg:px-20 border-t-2 border-gray-600 ${COLORS.BG_GRAY_LIGHT}`}
      >
            ...
            <Link to={ROUTES.GROCERY_LISTS}>
              ...
              >
                ...
                <p
                  className={`${COLORS.TEXT_PRIMARY} text-center leading-relaxed`}
                >
                  Automatically create a shopping list from your selected
                  recipes with custom servings amounts
                </p>
              </div>
            </Link>
